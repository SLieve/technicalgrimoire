...
<div class="column column-1-2">
    <article class="project-card">
      <a href="/files/boneHatch.pdf" class="no-hover no-print-link " tabindex="-1">
        <div class="project-card-img img sixteen-nine">
      ...
      <h3 class="project-card-title">
        <a href="/files/boneHatch.pdf" class="flip-title">My Bones are Ready to Hatch!</a>
      </h3>
...
<div class="columns">
  <div class="column column-1-2">
    <article class="project-card">
      ...
      <h3 class="project-card-title">
        <a href="/files/UVG_Ref.pdf" class="flip-title">Ultraviolet Grasslands + Troika</a>
      </h3>
