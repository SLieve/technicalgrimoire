...
function flipCoin(token) {
  ...
  switch (token) {
    ...
    case ("End Round"):
      ...
      coinTxt = "End Round";
      bgColor = "silver";
      turnText = "<p style=\"margin: unset;\"><strong>" + turnNumber + ". End Round" + "</strong><br>Resolve all effects, adjust the numbers, and click \"New Round\".</p>";
      break;
...
function countTokens() {
  ...
  tokenText = colorText + "<h3 class=\"tightSpacing\"><strong>Tokens Remaining:</strong></h3><p><ul>";
  ...
  if (countEnd > 0) {
    tokenText = tokenText + "<li>" + (countEnd) + " End Round token</li>";
  }
