...
function startHunt() {
  ...
  document.getElementById("mainButtons").style = "";  
...
function nextLocation() {
  if (document.getElementById("locBtn").innerText != "Next Location") {
    document.getElementById("locBtn").innerText = "Next Location";
  ...
  var locationtext = "<div class=\"tightSpacing h3\">";
  locationtext = locationtext + nextLocation.name + "</div>";
  locationtext = locationtext + "<p>" + nextLocation.description + "</p>";
  locationtext = locationtext + "<hr class=\"tightSpacing\">" + nextPaths();

  document.getElementById("mainButtons").style = "";
  document.getElementById("locationCard").innerHTML = locationtext;
  }
...
function nextPaths() {
  ...
  for (i = 0; i < numPaths; i++) {
    ...
    return pathsText + "</ul></p>";
  }

function nextEncounter() {

    document.getElementById("locBtn").innerText = "Show Location";
